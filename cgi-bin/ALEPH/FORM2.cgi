...
while (@row = $sth->fetchrow_array) {
	      ...
	      print "<FORM ACTION=\"\/cgi-bin\/ALEPH\/URECORD.cgi\" METHOD=\"post\">\n";
...
sub match {
    ...
    $statement = "select report.summary, people.phone, people.name, response.text, response.name from report, people, response WHERE people.id = report.id and report.summary = '$summary' and  people.phone = '$phone' and people.name = '$name' and response.text = '$mresponse' and response.name = '$rname'";
