...
if ($id =~ /\D/){
    print "<HTML>\n<HEAD>\n<TITLE>ALEPH Maintenance TEST</TITLE>\n</HEAD>\n<BODY>\n";
...
print "<HTML>\n<HEAD>\n<TITLE>ALEPH Reports Maintenance Test- Record $id</TITLE>\n</HEAD>\n<BODY BACKGROUND=\"\/IMG\/bk2.gif\">\n";
print "<center>\n";
print "<H1>ALEPH Reports Maintenance Test - Record $id</H1>\n";
print "<FORM ACTION=\"\/cgi-bin\/ALEPH\/ALEPHform2.cgi\" METHOD=post>\n";
print "<INPUT TYPE=\"button\" VALUE=\"ALEPH Summaries\" onClick=\"parent.location='\/cgi-bin\/XALEPH\/ALEPHsum.cgi?id'\">\n";
...
$statement =   "SELECT people.grp, people.campus, people.phone, people.name, report.date, report.status, report.summary, report.text, report.supress, report.cataloger, people.email FROM people, report WHERE people.id = report.id and people.id = $id";
...
print "<P>\n";
print "<B>Email:</b>\n";
print "<textarea wrap=\"physical\" name=email maxlength=30>$email</textarea>\n";
print "<B>Submitted by:</b>\n";
print "<textarea wrap=\"physical\" name=cataloger maxlength=30>$cataloger</textarea>\n";
print "<P>\n";
print "<B>Name:</B>\n";
...
print "<B>Name:</B>\n";
print "<textarea wrap=\"physical\" name=rname cols=30 maxlength=30>$rname</textarea><br><br>\n";
print "You must enter text or update the text field in order for the email to be generated.\n";
print "<BR><BR>\n";
print "<B>Response:</B>\n";
...
print "<INPUT TYPE=\"radio\" NAME=\"mail\" VALUE=\"yes\" checked>Yes\n";
print "<INPUT TYPE=\"radio\" NAME=\"mail\" VALUE=\"no\">No\n";
print "&nbsp;&nbsp;&nbsp;<B>Email Recipient:</B>\n";
print "&nbsp;&nbsp;&nbsp;<textarea wrap=\"physical\" name=semail cols=30 maxlength=50>$semail</textarea>\n";
print "</TR>\n";
print "</TABLE><br>\n";
print "<INPUT TYPE=\"hidden\" NAME=\"filter_value\" VALUE=\"$filter_value\">\n";
print "</FORM>\n";
