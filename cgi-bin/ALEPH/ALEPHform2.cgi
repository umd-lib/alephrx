...
$from = "aleph\@itd.umd.edu (ALEPH Web Report)";
$id = "";
$sort = "id";
...
print "<TD><FONT SIZE=-1><B><INPUT TYPE=\"submit\" VALUE=\"  Date  \" NAME=\"DATE\"></TD></TR>\n";
...
while (@row = $sth->fetchrow_array) {
	      ...
	      print "</FORM>\n";
	      print "<TD BGCOLOR=\"#FFCC66\"><FONT SIZE=-1>#&nbsp;<a href=\"\/cgi-bin\/XALEPH\/ALEPHsum_full.cgi?$row[0]\">$row[0]</TD>\n";
	      print "<TD BGCOLOR=\"#CCCCCC\"><FONT SIZE=-1>&nbsp;$row[3]</TD>\n";
	      print "<TD BGCOLOR=\"#E8E8E8\"><FONT SIZE=-1>&nbsp;$row[1]</TD>\n";
	      print "<TD BGCOLOR=\"#CCCCCC\"><FONT SIZE=-1>&nbsp;$row[7]</TD>\n";
	      print "<TD BGCOLOR=\"#E8E8E8\"><FONT SIZE=-1>&nbsp;$row[2]</TD>\n";
	      print "<TD BGCOLOR=\"#CCCCCC\"><FONT SIZE=-1>&nbsp;$row[4]</TD>\n";
	      print "<TD BGCOLOR=\"#E8E8E8\"><FONT SIZE=-1>&nbsp;$row[5]</TD>\n";
...
#	      print "</FORM>\n";
	      ...
	      $count = 0;
	      &count_reply;
	      print "<TD><font size=-1>$reply_count</TD></TR>\n";
...
if ($ITM) {
    $filter = "and people.grp like 'Item Maintenanc%'";
}
...
if ($CHANGE) {
    $filter = "and report.status = 'change request'";
}
...
print "<HTML>\n<HEAD><BR>\n";
print "<TITLE>Aleph Reports Maintenance- TEST</TITLE>\n</HEAD>\n<BODY BACKGROUND=\"\/IMG\/bk2.gif\">\n";
...
print "<a NAME=\"top\"></a>\n";
print "<center>\n";
print "<H1>ALEPH Reports Maintenance - TEST</H1>\n";
...
$statement =   "SELECT people.id, people.grp, people.campus, report.summary, report.status, DATE_FORMAT(report.date,'%m/%d/%y'), response.name, people.name FROM people, report, response WHERE report.supress = 'no' and people.id = report.id and people.id = response.parent_id $filter ORDER BY $sort $option LIMIT $limit, 30";
...
$summary =~ s/\\'/\'/g;
	...
	print MAIL "Subject: RE:#$id:$campus-$summary\n";
	print MAIL "This is a RESPONSE to the ALEPH Web Report listed below\n";
	print MAIL "http:\/\/www.itd.umd.edu\/cgi-bin\/XALPEH\/ALEPHsum_full.cgi?$id\n";
	print MAIL "\n";
	print MAIL "\n";
...
#sets the recipient variable according to the "grp" or "status" value of the report record.
...
sub recipient {
    ...
    if ($grp eq "Item Maintenance") {
        $recipient = "3dlm\@itd.umd.edu,3circ\@itd.umd.edu";
    }

    if ($grp eq "Item Maintenanc") {
	$recipient = "3dlm\@itd.umd.edu,3circ\@itd.umd.edu";
    }
...
$updated = "<P><FONT COLOR=\"#FF0000\"> Record $id has been updated!</FONT></P>"
...
sub filter_display  {
    ...
    if ($filter eq "and report.status = 'change request'") {
...
print "Content-type: text/html\n\n";
print "<HTML>\n<HEAD>\n<TITLE>Aleph Report Maintenance Summaries</TITLE>\n</HEAD>\n<BODY>\n";
print "<FORM ACTION=\"ALEPHform2.cgi?id\" METHOD=\"post\">\n";
print "<a NAME=\"top\"></a>\n";
print "<center>\n";
print "<FONT SIZE=\"-1\"><INPUT TYPE=\"button\" VALUE=\"Report Web Form\" onClick=\"parent.location ='\/cgi-bin\/ALEPHform.cgi'\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>\n";
print "<FONT SIZE=\"+3\"><STRONG>ALEPH Report Maintenance Summaries</STRONG></FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n";
print "<FONT SIZE=\"-1\"><INPUT TYPE=\"button\" VALUE=\"Report Statistics\" onClick=\"parent.location ='\/cgi-bin\/XALEPH\/ALEPHstats.cgi'\"></FONT><br><br>\n";
print "<FONT SIZE=\"-1\">Select one of the following to filter reports.</font>\n";
print "<table border=\"2\">\n";
print "<tr>\n";
print "<td width=\"100\" align=\"center\"><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"  Acquisitions  \" NAME=\"ACQ\"></td>\n";
print "<td width=\"50\"><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\" Circulation \" NAME=\"CIRC\"></td>\n";
print "<td><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"    Cataloging    \" NAME=\"CAT\"></td>\n";
print "<td><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"Item Maintenance\" NAME=\"ITM\"></td>\n";
print "<td width=\"50\"><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"  Reserves   \" NAME=\"RES\"></td>\n";
print "<td><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"Serials\" NAME=\"SRQ\"></td>\n";
print "<td><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"    Technical    \" NAME=\"TECH\"></td>\n";
print "<td><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\" Web OPAC  \" NAME=\"PAC\"></td>\n";
print "</tr>\n";
print "<tr>\n";
print "<td width=\"50\" align=\"center\"><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"       New         \" NAME=\"NEW\"></td>\n";
print "<td width=\"50\"><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"   Pending   \" NAME=\"PENDING\"></td>\n";
print "<td width=\"50\"><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"Report Request\" NAME=\"URGENT\"></td>\n";
print "<td><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\" Change Request  \" NAME=\"CHANGE\"></td>\n";
print "<td width=\"50\"><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\" Postponed \" NAME=\"POSTPONED\"></td>\n";
print "<td><font size=\"-1\"><INPUT TYPE=\"submit\" VALUE=\"Closed\" NAME=\"CLOSED\"></td>\n";
print "<td colspan=\"2\"><font size=\"-1\"><INPUT TYPE=\"button\" VALUE=\"    All Maintenance Summaries     \" onClick=\"parent.location='ALEPHform2.cgi?id'\"></td></tr>\n";
print "<tr><td BGCOLOR=\"#FFCC66\" colspan=\"2\"><font size=\"-1\">&nbsp;&nbsp;FILTER = $filter_display</font></td><td cellpadding=\"2\" BGCOLOR=\"#FFCC66\" colspan=\"2\"><font size=\"-1\">&nbsp;&nbsp;SORT = $sort_display</font></td><td cellpadding=\"2\" colspan=\"4\" BGCOLOR=\"#FFCC66\"><font size=\"-1\">&nbsp;&nbsp;ORDER = $option_value</font></td>\n";
#print "<td BGCOLOR=\"#F3F49C\"><font size=\"-1\">&nbsp;&nbsp;page $page_number of $num_pages</font></td>\n";

print "</tr></table>\n";
print "</FORM>\n";
print "<FORM ACTION=\"ALEPHurecord.cgi\" METHOD=\"post\">\n";
print "<FONT SIZE=+1 COLOR=\"#FF0000\">&nbsp;&nbsp;*</FONT><FONT SIZE=-1>&nbsp;&nbsp;Indicates an ITD response.&nbsp;</FONT>\n";
#print "<FONT SIZE=+1 COLOR=\"#0000FF\">&nbsp;&nbsp;*</FONT><FONT SIZE=-1>&nbsp;&nbsp;Indicates a User reply.</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n";
print "<B>Go to report # :</B>\n";
print "<INPUT TYPE=\"text\" NAME=\"record\" SIZE=3>\n";
print "<INPUT TYPE=\"submit\" VALUE=\"GO\">\n";
print "&nbsp;&nbsp;&nbsp;&nbsp;<FONT SIZE=\"-1\"><INPUT TYPE=\"button\" VALUE=\"Basic Search\" onClick=\"parent.location ='\/cgi-bin\/ALEPH\/ALEPHsearch.cgi'\"></FONT><br><br>\n";
print "</FORM>\n";
...
&page_rules;
print "</FORM>\n";
#print "<FORM ACTION=\"FORM3.cgi?id\" METHOD=\"post\">\n";
#print "<INPUT TYPE=\"hidden\" name=\"val\" VALUE=\"$sort\">\n";
#print "<INPUT TYPE=\"hidden\" name=\"page_number\" VALUE=\"$page_number\">\n";
#print "</FORM>\n";
...
sub match {
    ...
    $statement = "select report.summary, people.phone, people.name, response.text, response.name from report, people, response WHERE people.id = report.id and report.id = response.parent_id and report.summary = '$summary' and  people.phone = '$phone' and people.name = '$name' and response.text = '$mresponse' and response.name = '$rname'";
...
#sets the text for $closed_text based on $status


#if ($status = 'closed') {
#$closed_text = "THIS REPORT IS BEING CLOSED. PLEASE REPLY IF YOU HAVE ADDITIONAL INFORMATION.\n";
#} else {
#$closed_text = "";
#}
